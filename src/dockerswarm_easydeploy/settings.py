"""
Django settings for dockerswarm_easydeploy project.
...
SECRET_KEY = 'django-insecure-28ke9_h2ory*6t5jc6jin#_vvqlh@)8+bqybsoh!s1$$uby(vv'
...
ROOT_URLCONF = 'dockerswarm_easydeploy.urls'
